...
class NewCostFunctionTest extends AnyFlatSpec{
  ...
  "Large Window test" should "compute correct costs" in {
    ...
    solver = new TimeShiftedRelaxedINDDynamicProgrammingSolver(history1,history3,delta,false)
    assert(solver.costFunction(toInstant(10),toInstant(10),toInstant(20))==10)
    solver = new TimeShiftedRelaxedINDDynamicProgrammingSolver(history1,history4,delta,false)
    assert(solver.costFunction(toInstant(10),toInstant(10),toInstant(20))==10)
    assert(solver.costFunction(toInstant(10),toInstant(7),toInstant(20))==5)
    solver = new TimeShiftedRelaxedINDDynamicProgrammingSolver(history1,history5,delta,false)
    ...
    solver = new TimeShiftedRelaxedINDDynamicProgrammingSolver(history1,history6,delta,false)
    assert(solver.costFunction(toInstant(10),toInstant(10),toInstant(20))==10)
  ...
  "Small Window test" should "compute correct costs" in {
    ...
    delta = 1
    solver = new TimeShiftedRelaxedINDDynamicProgrammingSolver(history1,history2,delta,false)
