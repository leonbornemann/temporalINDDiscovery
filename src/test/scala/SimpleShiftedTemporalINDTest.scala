...
class SimpleShiftedTemporalINDTest extends AnyFlatSpec{
  ...
  "Different Validation Variants Tested" should "work correctly" in {
    ...
    var shiftedTemporalINDCustomFunction = new ShifteddRelaxedCustomFunctionTemporalIND(history1, history2, 2, 0,new ConstantWeightFunction(ChronoUnit.NANOS),ValidationVariant.FULL_TIME_PERIOD)
    ...
    shiftedTemporalINDCustomFunction = new ShifteddRelaxedCustomFunctionTemporalIND(history1, history2, 2, 0,new ConstantWeightFunction(ChronoUnit.NANOS),ValidationVariant.LHS_ONLY)
    assert(simpleRelaxedTemporalIND.absoluteViolationScore == 3 + 2 + 2)
    ...
    shiftedTemporalINDCustomFunction = new ShifteddRelaxedCustomFunctionTemporalIND(history1, history2, 2, 0,new ConstantWeightFunction(ChronoUnit.NANOS),ValidationVariant.RHS_ONLY)
    ...
    shiftedTemporalINDCustomFunction = new ShifteddRelaxedCustomFunctionTemporalIND(history1, history2, 2, 0,new ConstantWeightFunction(ChronoUnit.NANOS),ValidationVariant.LHS_UNION_RHS)
    assert(simpleRelaxedTemporalIND.absoluteViolationScore == 3 + 2 + 2)
    ...
    shiftedTemporalINDCustomFunction = new ShifteddRelaxedCustomFunctionTemporalIND(history1, history2, 2, 0,new ConstantWeightFunction(ChronoUnit.NANOS),ValidationVariant.LHS_INTERSECT_RHS)
    assert(simpleRelaxedTemporalIND.absoluteViolationScore == 1+2)
