package de.hpi.temporal_ind.data.attribute_history.data.file_search

import com.typesafe.scalalogging.StrictLogging
import de.hpi.temporal_ind.data.attribute_history.data.file_search.IndexedColumnHistories.{lowerIDBound, upperIDBound}
