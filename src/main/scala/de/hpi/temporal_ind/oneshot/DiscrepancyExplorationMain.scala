...
object DiscrepancyExplorationMain extends App {
  ...
  val searcher = new TINDSearcher(dm,new File(""),new File("/home/leon/data/temporalINDDiscovery/wikipedia/tmp/"),params,"test",true,4096,TimeSliceChoiceMethod.RANDOM,-4984250756083210152L,12,new File("/home/leon/data/temporalINDDiscovery/wikipedia/tmp/meta/"))
